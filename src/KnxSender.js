 ...
 */
const debug = require('debug')('knx.js:KnxSender');
...
KnxSender.prototype.CreateActionDatagramCommon = function (destinationAddress, /*buffer*/data, /*buffer*/header) {
  ...
  debug('KnxSender.CreateActionDatagramCommon datagram[%s]', datagram.toString('hex'));
  return datagram;
};
...
KnxSender.prototype.CreateRequestStatusDatagramCommon = function (destinationAddress, /*buffer*/datagram, cemi_start_pos) {
  ...
  debug('KnxSender.CreateRequestStatusDatagramCommon datagram[%s]', datagram.toString('hex'));
  return datagram;
};
